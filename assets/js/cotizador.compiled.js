...
const FLUJOS = {
  identidad: {
    ...
    pasos: [{
      id: "nivel",
      tipo: "single",
      q: "¿Hasta dónde llega el encargo?",
      op: [{
        id: "logo",
        t: "Solo logotipo",
        d: "Marca y variaciones, sin sistema.",
        h: 25
      }, {
        id: "sistema",
        t: "Logo + sistema base",
        d: "Marca, color, tipografía y grilla.",
        h: 37
      }, {
        id: "completa",
        t: "Identidad completa + manual",
        d: "Sistema y guía de uso.",
        h: 47
      }]
    }, {
      id: "origen",
      tipo: "single",
      q: "¿Marca nueva o rediseño?",
      op: [{
        id: "nombre",
        t: "Nueva, ya tiene nombre",
        h: 0
      }, {
        id: "naming",
        t: "Nueva, hay que crear el nombre",
        d: "Incluye naming.",
        h: 8
      }, {
        id: "redis",
        t: "Rediseño de algo existente",
        h: -4
      }]
    }, {
      id: "research",
      tipo: "single",
      q: "¿Hay investigación o posicionamiento previo?",
      op: [{
        id: "hacer",
        t: "No; la hacemos nosotros",
        d: "Incluida en la base.",
        h: 0
      }, {
        id: "tiene",
        t: "Sí, ya está hecha",
      ...
      op: [{
        id: "normal",
        t: "Normal (1 a 2 meses)",
        mult: 1
      }, {
        id: "urgente",
        t: "Urgente (menos de 1 mes)",
        d: "Recargo por prioridad.",
        mult: 1.3
      }]
    }]
  },
  editorial: {
    ...
    pasos: [{
      ...
      op: [{
        ...
        id: "fanzine",
        t: "Fanzine / pieza corta",
        h: 8
      }]
    }, {
      id: "paginas",
      tipo: "slider",
      q: "¿Cuántas páginas, aproximadamente?",
      min: 8,
      max: 160,
      step: 4,
      def: 64,
      ...
      id: "densidad",
      tipo: "single",
      q: "¿Cómo es el contenido por página?",
      op: [{
        id: "texto",
        t: "Texto corrido",
        d: "Pocas imágenes.",
        ...
        id: "mixto",
        t: "Mixto: texto e imágenes",
        perPage: 0.5
      }, {
        id: "visual",
        t: "Muy visual",
        d: "Catálogo, fotolibro.",
        perPage: 0.8
      }]
    }, {
      id: "portada",
      tipo: "single",
      q: "¿Incluye diseño de portada?",
      op: [{
        id: "si",
        t: "Sí, diseñar portada",
        h: 8
      }, {
        id: "no",
        t: "No / ya existe",
      ...
      id: "contenido",
      tipo: "single",
      q: "¿En qué estado llega el contenido?",
      op: [{
        id: "listo",
        t: "Texto e imágenes listos",
        h: 0
      }, {
        id: "ordenar",
        t: "Hay que ordenarlo",
      ...
      id: "imagenes",
      tipo: "single",
      q: "¿Cuánto tratamiento de imagen?",
      op: [{
        id: "ninguna",
        t: "Sin tratamiento",
        h: 0
      ...
      op: [{
        id: "imprenta",
        t: "Impreso: preparar para imprenta",
        h: 5
      }, {
        id: "digital",
        t: "Solo digital",
      ...
      id: "revisiones",
      tipo: "single",
      q: "¿Rondas de revisión?",
      sub: "Dos vienen incluidas.",
      op: [{
        id: "estandar",
        t: "Las 2 incluidas",
        h: 0
  ...
  primera: {
    ...
    pasos: [{
      ...
      op: [{
        id: "particular",
        t: "Para mí o un grupo particular"
      }, {
        id: "empresa",
        t: "Para mi empresa u organización",
        d: "Programa a medida para un equipo."
      }]
    }, {
      id: "grupo",
      tipo: "slider",
      ...
      op: [{
        ...
        id: "presencial",
        t: "Presencial",
        d: "Suma logística y traslado por sesión."
      }, {
        id: "mixta",
        t: "Mixta"
      }]
      ...
      op: [{
        ...
        id: "libro",
        t: "+ Libro impreso",
        d: "Curaduría, maquetación e impresión."
      }]
    }]
  }
};
const FACTORES = {
  identidad: [{
    ...
    dir: "sube",
    peso: 0.07,
    label: "Hay que empezar a diseñar antes de que definan qué son / a quién le hablan",
    porque: "El diseño avanza sobre una base incompleta: más rutas y reproceso."
  }, {
    id: "i_decisores",
    dir: "sube",
    peso: 0.06,
    label: "Aprueba más de una persona (socios, directorio)",
    porque: "Cada ronda se multiplica y aparecen criterios en conflicto."
  }, {
    id: "i_naming",
    dir: "sube",
    peso: 0.06,
    label: "Hay que crear el nombre desde cero",
    porque: "El naming es lo más subjetivo y lo que más rondas toma."
  }, {
    id: "i_sinref",
    dir: "sube",
    peso: 0.04,
    label: "No traen referencias de lo que les gusta",
    porque: "Sin un norte visual, la exploración es más amplia."
  }, {
    id: "i_rutas",
    dir: "sube",
    peso: 0.05,
    label: "Quieren ver varias rutas distintas desde el inicio",
    porque: "Cada ruta es casi un diseño completo en paralelo."
  }, {
    id: "i_scope",
    dir: "sube",
    peso: 0.04,
    label: "La lista de aplicaciones queda abierta (\"vamos viendo\")",
    porque: "El alcance crece durante el proyecto."
  }, {
    id: "i_nombreok",
    dir: "baja",
    peso: 0.04,
    label: "El nombre ya está definido y conforme",
    porque: "Se elimina la etapa más iterativa."
  }, {
    id: "i_undecisor",
    dir: "baja",
    peso: 0.05,
    label: "Decide una sola persona con poder de firmar",
    porque: "Menos rondas, criterio único."
  }, {
    id: "i_briefok",
    dir: "baja",
    peso: 0.05,
    label: "Traen brief y referencias claras",
    porque: "Acota la exploración desde el inicio."
  }, {
    id: "i_unaruta",
    dir: "baja",
    peso: 0.03,
    label: "Aceptan trabajar sobre una sola ruta",
    porque: "Menos exploración en paralelo."
  }, {
    id: "i_reusa",
    dir: "baja",
    peso: 0.03,
    label: "Hay material previo reutilizable (líneas, manual)",
    porque: "Parte de una base existente."
  }],
  editorial: [{
    id: "e_texto",
    dir: "sube",
    peso: 0.08,
    label: "El texto todavía está en edición / no está cerrado",
    porque: "Cambios de extensión rompen la maquetación ya hecha; se rehace."
  }, {
    id: "e_paralelo",
    dir: "sube",
    peso: 0.06,
    label: "Hay que maquetar en paralelo mientras llega el contenido",
    porque: "Se trabaja sobre borradores y se rehace al llegar lo final."
  }, {
    id: "e_imgs",
    dir: "sube",
    peso: 0.05,
    label: "Las imágenes no están definidas o son de baja calidad",
    porque: "Hay que gestionarlas, tratarlas o pedir reemplazos."
  }, {
    id: "e_indice",
    dir: "sube",
    peso: 0.05,
    label: "No hay índice / estructura final definida",
    porque: "La grilla y las maestras se rehacen si cambia la estructura."
  }, {
    id: "e_comite",
    dir: "sube",
    peso: 0.06,
    label: "Aprueba un comité o varias áreas",
    porque: "Las rondas se multiplican."
  }, {
    id: "e_imprenta",
    dir: "sube",
    peso: 0.04,
    label: "Lleva terminaciones especiales o imprenta externa",
    porque: "Más vueltas técnicas y pruebas de color."
  }, {
    id: "e_textook",
    dir: "baja",
    peso: 0.06,
    label: "El texto está cerrado y corregido",
    porque: "No hay reproceso por cambios de contenido."
  }, {
    id: "e_imgok",
    dir: "baja",
    peso: 0.04,
    label: "El banco de imágenes está definido y en buena resolución",
    porque: "Sin gestión ni tratamiento extra."
  }, {
    id: "e_indiceok",
    dir: "baja",
    peso: 0.04,
    label: "El índice / estructura ya está definido",
    porque: "La grilla se define una sola vez."
  }, {
    id: "e_undecisor",
    dir: "baja",
    peso: 0.04,
    label: "Decide una sola contraparte",
    porque: "Menos rondas."
  }, {
    id: "e_reedicion",
    dir: "baja",
    peso: 0.03,
    label: "Es reedición sobre una línea existente",
    porque: "Parte de un sistema ya hecho."
  }],
  primera: []
};
...
function motor(cat, ans) {
  ...
  if (cat === "editorial") {
    ...
    horas += (tipo?.h || 0) + (portada?.h || 0) + (contenido?.h || 0) + (imagenes?.h || 0) + (preprensa?.h || 0) + (revisiones?.h || 0) + hMaq;
...
function Cotizador() {
  ...
  const agenda = flujo ? flujo.pasos.filter(p => (notas[p.id] || "").trim()).map(p => ({
    q: p.q,
  ...
  const setSingle = (pid, oid) => setAns(a => ({
    ...a,
    [pid]: oid
  }));
  const toggleMulti = (pid, oid) => setAns(a => {
    ...
    return {
      ...a,
      [pid]: cur.includes(oid) ? cur.filter(x => x !== oid) : [...cur, oid]
    };
  });
  const setSlider = (pid, v) => setAns(a => ({
    ...a,
    [pid]: v
  }));
